...
<div class="topnav">
  ...
  <a href="contact.html" >Contact</a>
   ...
   <a href="index1.html" class="alltime" style="float: right;">Logout</a>
    ...
    <div class="d1 zoom"><img src="cad7.jpeg" height=100% width=100%></div>
   <div class="d2">
        <h1> Dairy Milk Silk Caramello </h1><br>
    <br>

        <h3> Description</h3>
    <ul>
        <li>Cadbury Dairy Milk Silk comes in exciting Caramello flavor. </li>
    <li>Your favourite Cadbury dairy milk now in a softer, smoother and creamier taste.</li>
    <li>Manufactured on equipment that also processes products containing tree nuts & wheat.</li>
    </ul>
 <%
try{
	...
	Class.forName("oracle.jdbc.driver.OracleDriver");
      ...
      String vsql="select * from product1 where pid=1";
