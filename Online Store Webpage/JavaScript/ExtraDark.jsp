...
<div class="topnav">
  ...
  <a href="contact.html" >Contact</a>
   ...
   <a href="index1.html" class="alltime" style="float: right;">Logout</a>
    ...
    <div class="d1 zoom"><img src=hes1.jpg height=100% width=100%></div>
   <div class="d2">
        <h1> Hershey's Extra Dark Chocolate</h1><br>
    <br>

        <h3> Description</h3>
    <ul>
        <li>Perfect for everyday snacking, sharing, and holiday celebrations.</li>
    <li> HERSHEY'S Extra Dark Cocoa Large Bar, pure Dark Chocolate, velvety smooth, rich dark chocolate from a select blend of cacao beans </li>
    <li> Gluten free candy. </li>
...
try{
	...
	Class.forName("oracle.jdbc.driver.OracleDriver");
      ...
      String vsql="select * from product1 where pid=14";
...
<form action="d14.jsp" method="post"> 
