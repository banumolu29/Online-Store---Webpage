...
<div class="topnav">
  ...
  <a href="contact.html" >Contact</a>
   ...
   <a href="index1.html" class="alltime" style="float: right;">Logout</a>
    ...
    <div class="d1 zoom"><img src=hes3.jpeg height=100% width=100%></div>
   <div class="d2">
        <h1> Hershey's Milk Chocolate Drops</h1><br>
    <br>

        <h3> Description</h3>
    <ul>
        <li>Perfect for everyday snacking, sharing, and holiday celebrations.</li>
    <li> Happiness is at hand when you grab a handful of rich and creamy Hershey's Milk Chocolate Drops!  </li>
    <li> The re-sealable bag lets you enjoy these bite-size chocolates any time you want a sweet treat – at home, work, school, or the movies.</li>
...
try{
	...
	Class.forName("oracle.jdbc.driver.OracleDriver");
      ...
      String vsql="select * from product1 where pid=15";
...
<form action="d15.jsp" method="post"> 
