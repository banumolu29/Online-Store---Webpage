...
<div class="topnav">
  ...
  <a href="contact.html" >Contact</a>
   ...
   <a href="index1.html" class="alltime" style="float: right;">Logout</a>
    ...
    <div class="d1 zoom"><img src=nes2.jpg height=100% width=100%></div>
   <div class="d2">
        <h1> Nestle's Munch</h1><br>
    <br>

        <h3> Description</h3>
    <ul>
        <li>NESTLE MUNCH is the country's most loved coated wafer range of products. </li>
    <li> It is a delicious crunchy treat for fans.</li>
...
try{
	...
	Class.forName("oracle.jdbc.driver.OracleDriver");
      ...
      String vsql="select * from product1 where pid=7";
...
<form action="d7.jsp" method="post"> 
