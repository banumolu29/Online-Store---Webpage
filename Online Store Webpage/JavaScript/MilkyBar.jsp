...
<div class="topnav">
  ...
  <a href="contact.html" >Contact</a>
   ...
   <a href="index1.html" class="alltime" style="float: right;">Logout</a>
    ...
    <div class="d1 zoom"><img src=nes1.jpg height=100% width=100%></div>
   <div class="d2">
        <h1> Nestle's Milky Bar</h1><br>
    <br>

        <h3> Description</h3>
    <ul>
        <li>A tasty, sweet and creamy treat that's loaded with the goodness of milk in every bite.  </li>
    <li> New NESTLE MILKYBAR with 8% more milk in the recipe.Now, even more creamy and more yummy.</li>
	<li>Play, Eat & Learn with the new NESTLE MILKYBAR.</li>
...
try{
	...
	Class.forName("oracle.jdbc.driver.OracleDriver");
      ...
      String vsql="select * from product1 where pid=8";
...
<form action="d8.jsp" method="post"> 
