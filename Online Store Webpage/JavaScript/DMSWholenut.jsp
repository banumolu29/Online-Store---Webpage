...
<div class="topnav">
  ...
  <a href="contact.html" >Contact</a>
   ...
   <a href="index1.html" class="alltime" style="float: right;">Logout</a>
    ...
    <div class="d1 zoom"><img src="cad10.jpg" height=100% width=100%></div>
   <div class="d2">
        <h1> Dairy Milk Whole Nut </h1><br>
    <br>

        <h3> Description</h3>
    <ul>
        <li>A whole lot of chocolate, and a whole lot of nut!  </li>
    <li>Deliciously crunchy, whole hazelnuts, covered in smooth Cadbury Dairy Milk milk chocolate..</li>
...
try{
	...
	Class.forName("oracle.jdbc.driver.OracleDriver");
      ...
      String vsql="select * from product1 where pid=2";
