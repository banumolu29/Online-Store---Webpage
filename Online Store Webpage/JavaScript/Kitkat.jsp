...
<div class="topnav">
  ...
  <a href="contact.html" >Contact</a>
   ...
   <a href="index1.html" class="alltime" style="float: right;">Logout</a>
    ...
    <div class="d1 zoom"><img src=nes7.jpg height=100% width=100%></div>
   <div class="d2">
        <h1> Nestle's KitKat</h1><br>
    <br>

        <h3> Description</h3>
    <ul>
        <li>Four fingers of crispy wafer covered in deliciously smooth Choco layer.</li>
    <li> KITKAT 4 Finger is a great treat when you are enjoying a break.</li>
	<li>It is a real milk chocolate, with a crisp wafer and creamy hazelnut filling.</li>
...
try{
	...
	Class.forName("oracle.jdbc.driver.OracleDriver");
      ...
      String vsql="select * from product1 where pid=12";
...
<form action="d12.jsp" method="post"> 
