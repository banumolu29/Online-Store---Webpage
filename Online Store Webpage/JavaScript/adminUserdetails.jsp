...
<%
		...
		try{
			...
			String vsql = "select * from logindetails";
			...
			out.println("<tr>");
			out.println("<th colspan=4><h2>USER DETAILS</th>");
			out.println("</tr>");
			out.println("<tr>");
			out.println("<th><h3>NAME</h3></th>");
			out.println("<th><h3>USER NAME</h3></th>");
			out.println("<th><h3>PASSWORD</h3></th>");
			out.println("<th><h3>REMARKS</h3></th>");
			out.println("</tr>");
			while(rs.next()){
				out.println("<tr>");
				...
				out.println("<td><a href=delEmp.jsp?uname="+rs.getString(2)+">Delete</a></td>");
				out.println("</tr>");
			}
			out.println("</table>");
